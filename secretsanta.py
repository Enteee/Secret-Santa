...
parser.add_argument("--port", type=int, default=80, help="Port to run webserver on")

parser.add_argument("--tls-cert", type=str, default=None, help="TLS certificate path")

parser.add_argument("--tls-key", type=str, default=None, help="TLS key path")

parser.add_argument(
    "--seed", type=int, default=secrets.randbits(128), help="Random seed"
)
...
def get_secret(secret):
    ...
    return (
        f"<html><body><h1>{santa} du bist secret santa von: {dest}</h1></body></html>"
    )
